...
class FullModelM(chainer.Chain):
    def __init__(self, T):
        w = chainer.initializers.HeNormal()
        super(FullModelM, self).__init__(
            conv1 = EXPConvolution2D(1, 16, 3, 1, 1, initialW=w, nobias=True, temperature=T),
            bn1 = L.BatchNormalization(16),
            res2 = ResBlock(T, 5, 16, 16),
            res3 = ResBlock(T, 5, 16, 32, 2),
            res4 = ResBlock(T, 5, 32, 64, 2),
            fc5 = EXPLinear(64, 10, temperature=T))
